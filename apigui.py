...
ero.grid(row=50,columnspan=15,pady=50)
def weather():
        try:
...
m1.add_command(label="Delhi",command=weather,font="lucida 15")
m1.add_command(label="Chicago",command=weather,font="lucida 15")
m1.add_separator()
m1.add_command(label="Canada",command=weather,font="lucida 15")
root.config(menu=mymenu)
mymenu.add_cascade(label="Check here",menu=m1,font="Algerian 20 bold")
...
Label(root,text="Home",font="Arial 12 ").grid(row=1,column=7,padx=12)
